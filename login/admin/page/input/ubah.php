                                ...
                                <div class="col-md-12">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="Diklat Fungsional" <?php if ($jn_dik=='Diklat Fungsional') {echo "selected";} ?>> Diklat Fungsional </option>
                                            <option value="Diklat Kepemimpinan" <?php if ($jn_dik=='Diklat Kepemimpinan') {echo "selected";} ?>> Diklat Kepemimpinan </option> 
                                            <option value="Latihan Dasar CPNS" <?php if ($jn_dik=='Latihan Dasar CPNS') {echo "selected";} ?>>Latsar CPNS </option>  
                                            <option value="Diklat Pemerintahan Desa" <?php if ($jn_dik=='Diklat Pemerintahan Desa') {echo "selected";} ?>>Diklat Pemerintahan Desa </option>
                                        </select>
                                        </div>  
                                        <div class="form-group">
...
error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
	...
	if ($simpan) {
		...
		$sql = $koneksi->query("update ii set nm_diklat='$a', jk_krk='$b', gambaran='$c', mk_tj='$d', mu='$e', jn_dik='$f' where id='$id'");
