        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active slide1">
                <div class="row"><div class="container">
                        ...
                        <img style="max-width: 100px;"  data-animation="animated zoomInLeft" src="http://organisasi.jatengprov.go.id/assets/template/inc/img/logo-jateng.png">
                    </div>
		                ...
		                <ul class="nav navbar-nav navbar-right">
		                    <li>
		                        <a href="?page=home1" style="font-weight:bold;color:#FFFFF0">Home</a>
      								...
      								<li>
		                        <a href="login/index.php" style="font-weight:bold;color:#FFFFF0" target="blank">Login</a>
		                    </li>
									<!--		<li>
												<a class="dropdown-toggle" data-toggle="dropdown" href="" style="font-weight:bold;color:#FFFFF0">Statistik</a>
													<ul class="dropdown-menu">
